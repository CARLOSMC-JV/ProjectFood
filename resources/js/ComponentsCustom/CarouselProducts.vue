...
<template>
    <div>
        <Carousel v-bind="settings" :transition="500" :breakpoints="breakpoints">
            <Slide v-for="product in products" :key="product.id" @click="redirectToProductDetails(product.subcategory.category.name, product)">
                <div class="carousel__item">
                    <img class="img-product" :src="product.images.length>0 ? product.images[0].image_path : product.image">
